...
class Controller_Common_Admin {
    ...
    public function favicon_admin() {
        ...
        $favicon .= '<!--[if lte IE 9]><link rel="icon" type="image/x-icon" href="' . theme_url( 'public/images/icon-tema-padrao-branco.png' ) . '" /> <![endif]-->';

        $favicon .= '<!-- Favicon Outros Navegadores -->';
        $favicon .= '<link rel="shortcut icon" type="image/png" href="' . theme_url( 'public/images/icon-tema-padrao-branco' ) . '" />';

        $favicon .='<!-- Favicon iPhone -->';
        $favicon .='<link rel="apple-touch-icon" href="' . theme_url( 'public/images/icon-tema-padrao-branco.png' ) . '" />';
